 ...
 */
class PlayerActionServiceRotateTest {
    ...
    private fun assertFigure(originalID: String, expFigAfterRotate: Array<IntArray>) {
        ...
        rootService.playerActionService.rotate(piece)
    ...
    fun testRefreshAfterRotateCalled() {
        ...
        rootService.playerActionService.rotate(Piece(arrayOf(intArrayOf(1)),"O1"))
        assertTrue(refreshableTest.refreshAfterRotate)
    }
